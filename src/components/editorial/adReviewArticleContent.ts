...
export const adReviewArticleContent = {
  fuseTea: {
    tr: {
      standfirst: 'Fuse Tea’nin “Budur” temalı şeftali reklamı; Kotler ve Keller’ın Değer Önerisi, Christensen’in Jobs-to-be-Done ve Friestad ile Wright’ın İkna Bilgisi Modeli yaklaşımlarını tek potada eriten çok katmanlı bir vaka örneğidir.',
    ...
    en: {
      standfirst: 'Fuse Tea’s peach-flavoured “Budur” commercial brings together Kotler and Keller’s value proposition, Christensen’s Jobs-to-be-Done, and Friestad and Wright’s Persuasion Knowledge Model in one layered case.',
    ...
    ru: {
      standfirst: 'Персиковая кампания Fuse Tea «Budur» объединяет ценностное предложение Котлера и Келлера, Jobs-to-be-Done Кристенсена и модель знания об убеждении Фристад и Райта.',
  ...
  oppoHamam: {
    tr: {
      ...
      intro: 'Fuse Tea’nin organik içgörüsünün aksine bu film, Keller, Kotler ve Christensen modelleri açısından dört temel noktada stratejik tıkanıklık yaşar.',
      sections: [
        ...
        { label: '05 · VAKA KARŞILAŞTIRMASI', heading: 'Fuse Tea ve OPPO arasındaki stratejik fark', blocks: [
          { type: 'table', headers: ['Kriter', 'Fuse Tea', 'OPPO'], rows: [
            ...
            ['Zihinde kalan', '“Budur” ve Fuse Tea', 'Tellak ve hamam esprisi'],
    ...
    en: {
      ...
      intro: 'Unlike Fuse Tea’s organic insight, the film runs into four strategic dead ends when viewed through Keller, Kotler, and Christensen.',
      sections: [
        ...
        { label: '05 · CASE COMPARISON', heading: 'The strategic gap between Fuse Tea and OPPO', blocks: [
          { type: 'table', headers: ['Criterion', 'Fuse Tea', 'OPPO'], rows: [
            ...
            ['What remains', '“Budur” and Fuse Tea', 'The attendant and bathhouse joke'],
    ...
    ru: {
      ...
      intro: 'В отличие от органичного инсайта Fuse Tea, этот ролик упирается в четыре стратегических тупика с точки зрения Келлера, Котлера и Кристенсена.',
      sections: [
        ...
        { label: '05 · СРАВНЕНИЕ КЕЙСОВ', heading: 'Стратегическая разница между Fuse Tea и OPPO', blocks: [
          { type: 'table', headers: ['Критерий', 'Fuse Tea', 'OPPO'], rows: [
            ...
            ['Что остается', '«Budur» и Fuse Tea', 'Банщик и шутка про баню'],
