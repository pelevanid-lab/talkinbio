...
import ActionRoom from '@/components/rooms/ActionRoom';

// Beiwe Motion — "Action Room". Podcast'ten farkı: sesle ilişkilendirilmiyor, boydan
// görüntü öne çıkıyor ve kimlik zorunlu değil (Twin ya da jenerik/rastgele karakter).
// Stil katmanı (anime/çizgi film/cinematic/fantastic) Post'un kilitli-şablon
// disipliniyle aynı mantıkla çalışıyor — bkz. `config/motionStyles.ts`.
type Props = {
  characterId: string;
...
export default function BeiweMotionClient({ characterId, initialShots, initialClips }: Props) {
