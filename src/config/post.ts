...
export const POST_FORMATS: PostFormat[] = [
  { id: 'feed', label: 'postFormatFeedLabel', width: 1080, height: 1350, hint: 'postFormatFeedHint' },
  { id: 'square', label: 'postFormatSquareLabel', width: 1080, height: 1080, hint: 'postFormatSquareHint' },
  { id: 'story', label: 'postFormatStoryLabel', width: 1080, height: 1920, hint: 'postFormatStoryHint' },
];
...
export const POST_TEMPLATES: PostTemplate[] = [
  ...
  {
    id: 'duyuru',
    label: 'postTemplateDuyuruLabel',
    pillar: 'postTemplateDuyuruPillar',
    hint: 'postTemplateDuyuruHint',
    imageMode: 'cover',
    background: { kind: 'solid', color: BRAND.ink },
    headlineColor: BRAND.paper,
  ...
  {
    id: 'aci',
    label: 'postTemplateAciLabel',
    pillar: 'postTemplateAciPillar',
    hint: 'postTemplateAciHint',
    imageMode: 'cover',
    background: { kind: 'solid', color: BRAND.ink },
    headlineColor: BRAND.paper,
  ...
  {
    id: 'soz',
    label: 'postTemplateSozLabel',
    pillar: 'postTemplateSozPillar',
    hint: 'postTemplateSozHint',
    imageMode: 'none',
  ...
  {
    id: 'gradient-duyuru',
    label: 'postTemplateGradientLabel',
    pillar: 'postTemplateGradientPillar',
    hint: 'postTemplateGradientHint',
    imageMode: 'cover',
  ...
  {
    id: 'sinema-posteri',
    label: 'postTemplateSinemaLabel',
    pillar: 'postTemplateSinemaPillar',
    hint: 'postTemplateSinemaHint',
    imageMode: 'cover',
