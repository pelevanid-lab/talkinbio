...
1. **Colors**:
   ...
   - Accent: Use `#FF6A5C` (Coral) for primary actions/highlights, `#FFEDE9` (Coral Tint) for light accent backgrounds, and `#2B6F5C` (Teal) for secondary highlights (like eyebrow text).
